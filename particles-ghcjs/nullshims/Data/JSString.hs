{-# LANGUAGE MagicHash, BangPatterns, TypeFamilies,
...
unpack' :: JSString -> String
unpack' = error "unpack': only available in JavaScript"
{-# INLINE unpack' #-}
...
uncons x = error "uncons: only available in JavaScript"
{-# INLINE [1] uncons #-}
...
splitAt (I# n) x = error "splitAt: only available in JavaScript"
{-# INLINE splitAt #-}
...
group' :: JSString -> [JSString]
group' x = error "group': only available in JavaScript"
{-# INLINE group' #-}
...
splitOn' pat src
  | null pat  = emptyError "splitOn'"
  | otherwise = error "splitOn': only available in JavaScript"
{-# NOINLINE splitOn' #-}
--- {-# INLINE [1] splitOn' #-}
...
chunksOf (I# k) p = error "chunksOf: only available in JavaScript"
{-# INLINE chunksOf #-}
...
breakOn pat src
  ...
  | otherwise = error "breakOn: only available in JavaScript"
{-# INLINE breakOn #-}
...
breakOnEnd pat src
  ...
  | otherwise = error "breakOnEnd: only available in JavaScript"
{-# INLINE breakOnEnd #-}
...
breakOnAll :: JSString              -- ^ @needle@ to search for
           ...
           -> [(JSString, JSString)]
breakOnAll = error "breakOnAll: only available in JavaScript"
{-# INLINE breakOnAll #-}
...
words = error "words: only available in JavaScript"
{-# INLINE words #-}

-- fixme: strict words' that allocates the whole list in one go
words' :: JSString -> [JSString]
words' x = error "words': only available in JavaScript"
{-# INLINE words' #-}
                              
-- | /O(n)/ Breaks a 'JSString' up into a list of 'JSString's at
-- newline 'Char's. The resulting strings do not contain newlines.
lines :: JSString -> [JSString]
lines = error "lines: only available in JavaScript"
{-# INLINE lines #-}

lines' :: JSString -> [JSString]
lines' ps = error "lines': only available in JavaScript"
{-# INLINE lines' #-}
...
stripPrefix = error "stripPrefix: only available in JavaScript"
{-# INLINE stripPrefix #-}
...
commonPrefixes = error "commonPrefixes: only available in JavaScript"
...
stripSuffix = error "stripSuffix: only available in JavaScript"
{-# INLINE stripSuffix #-}
...
js_pack = error "js_pack: only available in JavaScript"
...
js_eq = error "js_eq: only available in JavaScript"
...
js_compare = error "js_compare: only available in JavaScript"
--  "($1<$2)?-1:(($1>$2)?1:0)" js_compare :: JSString -> JSString -> Int#
js_singleton :: Char -> JSString
js_singleton = error "js_singleton: only available in JavaScript"
js_cons :: Char -> JSString -> JSString
js_cons = error "js_cons: only available in JavaScript"
js_snoc :: JSString -> Char -> JSString
js_snoc = error "js_snoc: only available in JavaScript"
js_substr :: Int# -> Int# -> JSString -> JSString
js_substr = error "js_substr: only available in JavaScript"
js_substr1 :: Int# -> JSString -> JSString
js_substr1 = error "js_substr1: only available in JavaScript"
js_substring :: Int# -> Int# -> JSString -> JSString
js_substring = error "js_substring: only available in JavaScript"
js_length :: JSString -> Int#
js_length = error "js_length: only available in JavaScript"
js_charWidthAt :: Int# -> JSString -> Int#
js_charWidthAt = error "js_charWidthAt: only available in JavaScript"
js_index :: Int# -> JSString -> Int#
js_index = error "js_index: only available in JavaScript"
js_indexR :: Int# -> JSString -> Int#
js_indexR = error "js_indexR: only available in JavaScript"
js_uncheckedIndex :: Int# -> JSString -> Int#
js_uncheckedIndex = error "js_uncheckedIndex: only available in JavaScript"

-- js_head and js_last return -1 for empty string
js_head :: JSString -> Int#
js_head = error "js_head: only available in JavaScript"
js_last :: JSString -> Int#
js_last = error "js_last: only available in JavaScript"

js_init :: JSString -> JSRef () -- null for empty string
js_init = error "js_init: only available in JavaScript"
js_tail :: JSString -> JSRef () -- null for empty string
js_tail = error "js_tail: only available in JavaScript"
...
js_concat = error "js_concat: only available in JavaScript"
-- debug this below!
js_replace :: JSString -> JSString -> JSString -> JSString
js_replace = error "js_replace: only available in JavaScript"
js_count :: JSString -> JSString -> Int#
js_count = error "js_count: only available in JavaScript"
js_unlines :: Exts.Any {- [JSString] -} -> JSString
js_unlines = error "js_unlines: only available in JavaScript"
js_unwords :: Exts.Any {- [JSString] -} -> JSString
js_unwords = error "js_unwords: only available in JavaScript"
js_isPrefixOf :: JSString -> JSString -> Bool
js_isPrefixOf = error "js_isPrefixOf: only available in JavaScript"
js_isSuffixOf :: JSString -> JSString -> Bool
js_isSuffixOf = error "js_isSuffixOf: only available in JavaScript"
js_isInfixOf :: JSString -> JSString -> Bool
js_isInfixOf = error "js_isInfixOf: only available in JavaScript"
js_drop :: Int# -> JSString -> JSString
js_drop = error "js_drop: only available in JavaScript"
js_dropEnd :: Int -> JSString -> JSString
js_dropEnd = error "js_dropEnd: only available in JavaScript"
js_take :: Int# -> JSString -> JSString
js_take = error "js_take: only available in JavaScript"
js_takeEnd :: Int# -> JSString -> JSString
js_takeEnd = error "js_takeEnd: only available in JavaScript"
js_replicate :: Int# -> JSString -> JSString
js_replicate = error "js_replicate: only available in JavaScript"
js_replicateChar :: Int -> Char -> JSString
js_replicateChar = error "js_replicateChar: only available in JavaScript"
js_isSingleton :: JSString -> Bool
js_isSingleton = error "js_isSingleton: only available in JavaScript"
js_intersperse :: Char -> JSString -> JSString
js_intersperse = error "js_intersperse: only available in JavaScript"
js_intercalate :: JSString -> Exts.Any {- [JSString] -} -> JSString
js_intercalate = error "js_intercalate: only available in JavaScript"
js_toUpper :: JSString -> JSString
js_toUpper = error "js_toUpper: only available in JavaScript"
js_toLower :: JSString -> JSString
js_toLower = error "js_toLower: only available in JavaScript"
