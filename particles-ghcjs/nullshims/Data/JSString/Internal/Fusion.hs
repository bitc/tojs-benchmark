...
js_newSingletonArray :: Char -> IO (JSRef ())
js_newSingletonArray = error "js_newSingletonArray: only available in JavaScript"
js_writeArray :: Char -> Int -> (JSRef ()) -> IO ()
js_writeArray = error "js_writeArray: only available in JavaScript"
js_packString :: (JSRef ()) -> IO JSString
js_packString = error "js_packString: only available in JavaScript"
js_packReverse :: (JSRef ()) -> IO JSString
js_packReverse = error "js_packReverse: only available in JavaScript"
